...
public class GetProductListProduct {
    ...
    @Expose
    private GetProductListQrCodeUrls qrCodeUrls;
    ...
    public GetProductListQrCodeUrls getQrCodeUrls() {
        return qrCodeUrls;
    }

    public void setQrCodeUrls(GetProductListQrCodeUrls qrCodeUrls) {
